...
export function WhatsAppConfig() {
  ...
  const fetchConfig = useCallback(
    async (acctId: string) => {
      ...
      try {
        ...
        if (error) {
          console.error('Falha ao carregar a linha de configuração:', error);
        }
  ...
  async function handleSave() {
    ...
    if (!config && (!accessToken.trim() || !tokenEdited)) {
      toast.error('O token de acesso é necessário para a configuração inicial');
      return;
    }
    ...
    try {
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciais salvas e verificadas. O registro de entrada foi ignorado (sem PIN) — consulte o status do registro abaixo.',
          { duration: 10000 }
        );
        setPin('');
      } else {
        toast.success(
          data.phone_info?.verified_name
            ...
            : 'WhatsApp conectado. Os eventos começarão a fluir dentro de um minuto.'
        );
  ...
  async function handleTestConnection() {
    try {
      ...
      console.error('Erro de conexão de teste:', err);
      setConnectionStatus('disconnected');
      toast.error(
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        toast.success(
          'O número está totalmente conectado – Meta está entregando eventos.'
        );
      } else {
        toast.error(
      ...
      console.error('verificação de registro falhou:', err);
  ...
  async function handleReset() {
    if (
      !confirm(
        'Isso excluirá a configuração atual do WhatsApp para que você possa inseri-la novamente. Continuar?'
      )
    ) {
      return;
    }
    ...
    try {
      ...
      toast.success(
        'Configuração limpa. Agora você pode inserir novamente suas credenciais.'
      );
      setConfig(null);
      setPhoneNumberId('');
      setWabaId('');
  ...
  function handleCopyWebhookUrl() {
    ...
    toast.success('URL do webhook copiado para a área de transferência');
  }
        ...
        <div className="space-y-6">
          ...
          <Alert className="bg-card border-border">
            ...
            <AlertDescription className="text-muted-foreground">
              {connectionStatus === 'connected'
                ? 'Seu token de acesso é autenticado com Meta. Consulte o status do registro abaixo para saber se os webhooks estão realmente conectados.'
                : statusMessage ||
                  'Configure suas credenciais Meta API abaixo para conectar sua conta do WhatsApp Business.'}
            </AlertDescription>
          </Alert>
                ...
                {isRegistered ? (
                  <>
                    ...
                    {config.registered_at
                      ...
                      : 'unknown'}
                    . Click <strong>Verifique com Meta</strong> se os eventos
                    pararem de chegar.
                  </>
                  ...
                  <>
                    ...
                    . Insira (ou corrija) o PIN de duas etapas abaixo e clique
                    em Salvar configuração para tentar novamente.
                  </>
                ) : (
                  <>
                    Este número foi salvo antes de existir o rastreamento do
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  placeholder="por exemplo 100234567890123"
                  value={phoneNumberId}
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="por exemplo 100234567890456"
                  value={wabaId}
              ...
              <div className="space-y-2">
                ...
                {config && !tokenEdited && (
                  <p className="text-muted-foreground text-xs">
                    O token está oculto por segurança. Digite-o novamente para
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-muted-foreground text-xs">
                  Uma string personalizada que você cria. Deve corresponder ao
                  token definido nas configurações do Meta webhook.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs leading-relaxed">
                  Necessário apenas para conectar{' '}
                  ...
                  <strong className="text-muted-foreground">
                    Números de metateste
                  </strong>{' '}
                  não têm PIN e estão pré-registrados – deixe em branco para
                  eles. Deixá-lo em branco também mantém um registro existente
                  intacto.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">
                Use este URL como retorno de chamada do webhook no Meta App
                Dashboard.
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <Accordion>
                <AccordionItem className="border-border">
                  ...
                  <AccordionContent className="text-muted-foreground">
                    <ol className="list-inside list-decimal space-y-1 text-sm">
                      ...
                      <li>Selecione “Comercial” como o tipo de aplicativo</li>
                ...
                <AccordionItem className="border-border">
                  ...
                  <AccordionContent className="text-muted-foreground">
                    <ol className="list-inside list-decimal space-y-1 text-sm">
                      <li>
                        No painel do seu aplicativo, clique em “Adicionar
                        produto”
                      </li>
                      <li>Encontre “WhatsApp” e clique em “Configurar”</li>
                      <li>
                        Siga o assistente de configuração para vincular sua
                        empresa
                      </li>
                    </ol>
                  </AccordionContent>
                ...
                <AccordionItem className="border-border">
                  <AccordionTrigger className="text-muted-foreground hover:text-foreground hover:no-underline">
                    <span className="flex items-center gap-2">
                      ...
                      Obtenha credenciais de API
                    </span>
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    <ol className="list-inside list-decimal space-y-1 text-sm">
                      <li>Vá para WhatsApp → Configuração da API</li>
                      <li>
                        Copie seu{' '}
                ...
                <AccordionItem className="border-border">
                  ...
                  <AccordionContent className="text-muted-foreground">
                    <ol className="list-inside list-decimal space-y-1 text-sm">
                      <li>Vá para WhatsApp → Configuração</li>
                      ...
                      <li>Inscreva-se no campo webhook “mensagens”</li>
                    </ol>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
              ...
              <div className="border-border mt-4 border-t pt-4">
                ...
                >
                  ...
                  Documentação da API Meta WhatsApp
                </a>
              </div>
            </CardContent>
          </Card>
