          ...
          <>
            {tags.length > 0 ? (
              ...
              <p className="text-muted-foreground text-sm">
                Ainda não há tags. Crie a sua primeira abaixo.
              </p>
            )}
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <Input
                placeholder="por exemplo Boletim informativo"
                value={newTagName}
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Exclua a etiqueta “{tagToDelete?.name}”? Isso a remove de todos os
              contatos e não pode ser desfeito.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
