...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: 'violet',
    name: 'Violeta',
    tagline: 'O padrão – confiante, ligeiramente brincalhão.',
  ...
  },
  {
    ...
    name: 'Esmeralda',
    tagline:
      'Codificado por crescimento, acena com a cabeça para mensagens sem copiar o verde do WhatsApp.',
    swatch: 'oklch(0.62 0.16 162)',
  },
  {
    id: 'cobalt',
    name: 'Cobalto',
    tagline: 'Azul B2B-SaaS limpo – calmo e produtivo.',
  ...
  },
  {
    ...
    name: 'Âmbar',
    tagline:
      'Caloroso e amigável – é bom para equipes de pequenas e médias empresas.',
    swatch: 'oklch(0.745 0.16 65)',
  },
  {
    id: 'rose',
    name: 'Rosa',
    tagline: 'Ousado e moderno – D2C, economia criadora, estilo de vida.',
