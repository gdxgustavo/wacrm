  ...
  try {
    ...
    if (rawTemplateRow && !isMessageTemplate(rawTemplateRow)) {
      return NextResponse.json(
        {
          error:
            'A linha do modelo está malformada localmente — execute "Sincronizar com a Meta" em Configurações para repará-la antes do disparo.',
        },
        { status: 500 }
      );
    }
    ...
    console.error('Erro no POST de transmissão do WhatsApp:', error);
    return NextResponse.json(
