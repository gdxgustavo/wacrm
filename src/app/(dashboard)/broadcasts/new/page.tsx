...
export default function NewBroadcastPage() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : 'Falha na transmissão';
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-foreground text-2xl font-bold">Nova transmissão</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          Crie e envie uma mensagem de difusão para seus contatos.
        </p>
      </div>
